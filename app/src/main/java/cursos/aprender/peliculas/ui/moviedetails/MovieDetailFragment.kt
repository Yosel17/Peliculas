package cursos.aprender.peliculas.ui.moviedetails
...
import cursos.aprender.peliculas.databinding.FragmentMovieDetailBinding
...
class MovieDetailFragment : Fragment(R.layout.fragment_movie_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtLanguage.text = "Language ${args.title}"
