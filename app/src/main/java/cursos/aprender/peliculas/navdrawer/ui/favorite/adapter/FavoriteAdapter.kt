package cursos.aprender.peliculas.navdrawer.ui.favorite.adapter
...
class FavoriteAdapter(
    private val favoriteList: List<Movie>,
    private val itemClickListener: FavoriteFragment,
    ...
    private inner class FavoriteViewHolder(val binding: FavoriteItemBinding, val context: Context) :
